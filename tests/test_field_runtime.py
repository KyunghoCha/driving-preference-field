...
def test_field_runtime_u_turn_transverse_prefers_inside_apex_over_outer_right_ridge() -> None:
    snapshot, context = load_toy_snapshot(ROOT / "cases/toy/u_turn.yaml")
    ...
    inside = runtime.query_state(StateSample(x=4.8, y=1.6, yaw=1.57))
    outer = runtime.query_state(StateSample(x=5.4, y=1.6, yaw=1.57))
