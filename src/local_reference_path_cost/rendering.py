...
CHANNEL_DESCRIPTIONS = {
    ...
    "progression_longitudinal_component": "Current implementation longitudinal function-space term before gain is applied. longitudinal_peak sets the family ceiling directly, and in the linear family longitudinal_shape also scales the ramp slope and endpoint ceiling.",
    "progression_transverse_term": "Exact current-implementation transverse term that the dominant guide contributes to score. Center peak, core shape, and outer-tail falloff are separated, so this term can exceed 1.0 through transverse_peak.",
