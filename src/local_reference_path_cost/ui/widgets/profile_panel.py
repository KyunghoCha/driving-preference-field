...
from local_reference_path_cost.contracts import QueryContext
from local_reference_path_cost.profile_contracts import ProfileSpec
...
class ProfilePanelWidget(QWidget):
    ...
    def set_profile_result(self, result: ComparisonProfileResult | None, *, selected_channel: str) -> None:
        ...
        try:
            from local_reference_path_cost.profile_inspection import profile_plot_png_bytes
