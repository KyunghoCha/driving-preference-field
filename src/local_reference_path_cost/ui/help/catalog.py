...
PARAMETER_SPECS: dict[str, ParameterSpec] = {
    ...
    "longitudinal_peak": ParameterSpec(
        key="longitudinal_peak",
        label="long peak",
        section_key="longitudinal",
        config_namespace="progression",
        tier="main",
    ...
    "transverse_family": ParameterSpec(
        ...
        tier="main",
        widget_kind="combo",
        practical_band="exponential | inverse | power | linear",
        technical_range="exponential | inverse | power | linear",
        options=("exponential", "inverse", "power", "linear"),
    ),
    "transverse_peak": ParameterSpec(
        key="transverse_peak",
        label="trans peak",
        section_key="transverse",
        config_namespace="progression",
    ...
    "transverse_falloff": ParameterSpec(
        key="transverse_falloff",
        label="trans falloff",
        section_key="transverse",
        config_namespace="progression",
        tier="main",
        widget_kind="double_spin",
        practical_band="0.0 .. 4.0",
        technical_range="0.0 .. 1000.0",
        numeric_range=(0.0, 1000.0),
    ),
