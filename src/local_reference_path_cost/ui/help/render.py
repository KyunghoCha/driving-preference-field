...
from local_reference_path_cost.ui.help.catalog import ADVANCED_PARAMETER_GROUPS, MAIN_PARAMETER_KEYS, PARAMETER_SPECS
from local_reference_path_cost.ui.help.copy import PANEL_NOTE_TEXT, PARAMETER_GUIDE_INTRO, PARAMETER_TEXTS, SECTION_TITLES
from local_reference_path_cost.ui.locale import DEFAULT_LANGUAGE, LANG_EN, LANG_KO
...
def parameter_help_html(language: str = DEFAULT_LANGUAGE) -> str:
    ...
    if lang == LANG_EN:
        ...
        main_intro = (
            "Start here when you are deciding score semantics: longitudinal frame, family, gain, transverse profile, and support ceiling. "
        ...
        interpretation_items = [
            ...
            "<code>drivable boundary</code> is an overlay. It is not additive base ordering.",
            "<code>Obstacle / Rule / Dynamic</code> are costmap views, not the base ordering layer.",
        ...
        main_intro = (
            "score semantics를 읽을 때는 여기서 시작한다. longitudinal frame, family, gain, transverse profile, support ceiling을 먼저 본다. "
        ...
        interpretation_items = [
            ...
            "<code>Obstacle / Rule / Dynamic</code>는 costmap 시각화다. base ordering와 같은 층이 아니다.",
