...
def parameter_help_html(language: str = DEFAULT_LANGUAGE) -> str:
    ...
    if lang == LANG_EN:
        ...
        advanced_intro = (
            ...
            "This section tunes discretization, support kernels, and weak modulation quality."
        )
        ...
        advanced_intro = (
            "semantics가 먼저 잡힌 뒤에만 연다. 이 섹션은 discretization, support kernel, 약한 modulation 품질을 다룬다."
        )
