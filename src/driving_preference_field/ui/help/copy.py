...
PARAMETER_GUIDE_INTRO = {
    LANG_EN: (
        ...
        "The current implementation evaluates one pooled blended progress field across all progression anchors, then reads transverse by projecting directly onto the nearest resampled progression-guide segment.\n"
    ...
    LANG_KO: (
        ...
        "현재 구현은 progression anchor 전체를 하나의 pooled blended progress field로 읽고, 횡방향은 가장 가까운 resampled progression guide segment에 직접 투영해 읽는다.\n"
