...
PARAMETER_TEXTS: dict[str, dict[str, dict[str, str]]] = {
    ...
    "transverse_peak": {
        LANG_EN: {
            ...
            "effect_down": "The center maximum is weaker, so transverse behaves more like a broad background preference than a strong center pull.",
        ...
        LANG_KO: {
            ...
            "effect_down": "중심 최대값이 약해져 transverse가 강한 center pull보다 넓은 배경 선호에 가까워진다.",
