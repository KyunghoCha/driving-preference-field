...
PARAMETER_GUIDE_INTRO = {
    LANG_EN: (
        ...
        "The current implementation evaluates one pooled blended coordinate field across all progression anchors.\n"
    ...
    LANG_KO: (
        ...
        "현재 구현은 progression anchor 전체를 하나의 pooled blended coordinate field로 읽는다.\n"
