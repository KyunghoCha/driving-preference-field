...
4. `docs/design/source_adapter_ko.md`
5. `docs/design/runtime_evaluation_contract_ko.md`
...
- generic source adapter SSOT와 reference adapter 추가
...
- 현재 상태는 `Phase 5 완료, Phase 6 준비 상태`
...
flowchart TD
    ...
    A2[fixtures/adapter/*] --> B2[source_adapter]
...
- source adapter SSOT: `docs/design/source_adapter_ko.md`
...
- Phase 5 source adapter SSOT와 reference adapter도 구현된 상태다
...
- geometry editing / interactive studio

Phase 5 proposal history는 reading 문서로만 남긴다.

- history: `docs/reading/phase5_adapter_proposal_ko.md`
...
6. `docs/design/source_adapter_ko.md`
7. `docs/design/base_field_terms_ko.md`
8. `docs/design/runtime_evaluation_contract_ko.md`
9. `docs/design/parameter_lab_ko.md`
10. `docs/status/roadmap_ko.md`
11. `docs/status/project_status_ko.md`
12. `docs/status/experiment_plan_ko.md`
...
## Evaluator, Adapter, 시각화

- package: `src/driving_preference_field/`
- toy cases: `cases/toy/`
- generic adapter fixtures: `fixtures/adapter/`
- tests: `tests/`

예시 실행:

1. `PYTHONPATH=src python -m driving_preference_field inspect-case --case cases/toy/straight_corridor.yaml`
2. `PYTHONPATH=src python -m driving_preference_field inspect-adapter-input --input fixtures/adapter/straight_corridor_generic.yaml`
3. `PYTHONPATH=src python -m driving_preference_field convert-adapter-input --input fixtures/adapter/straight_corridor_generic.yaml --summary-only`
4. `PYTHONPATH=src python -m driving_preference_field evaluate-state --case fixtures/adapter/left_bend_generic.yaml --x 4.7 --y 2.0 --yaw 1.0`
5. `PYTHONPATH=src python -m driving_preference_field evaluate-trajectory --case cases/toy/split_branch.yaml --trajectory '{"states":[{"x":4.6,"y":1.0,"yaw":0.55},{"x":5.3,"y":1.5,"yaw":0.55}]}'`
6. `PYTHONPATH=src python -m driving_preference_field render-case --case cases/toy/sensor_patch_open.yaml`
7. `PYTHONPATH=src python -m driving_preference_field parameter-lab --case fixtures/adapter/straight_corridor_generic.yaml`
