...
전체 phase 진행은 [로드맵 문서](./roadmap_ko.md)에서 관리한다.
...
현재 source adapter의 design SSOT는 `docs/reference/source_adapter_ko.md`에 있고, proposal history는 `docs/reading/history/phase5_adapter_proposal_ko.md`에 남긴다.
