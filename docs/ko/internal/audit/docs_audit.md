...
- 포털:
  - `docs/ko/index.md`
- 호환 안내:
  - `docs/ko/design/index.md`
- explanation:
  - `project_overview.md`
  - `engineering_operating_principles.md`
  - `research_scope.md`
  - `base_field_foundation.md`
- reference:
  - `input_semantics.md`
  - `source_adapter.md`
  - `base_field_terms.md`
  - `layer_composition.md`
  - `runtime_evaluation_contract.md`
  - `current_formula_reference.md`
- how-to:
  - `parameter_lab.md`
- status:
  - `roadmap.md`
...
- reading:
  - `history/archive/*`
  - `history/phase5_adapter_proposal.md`
  - `math/README.md`
  - `references/external_references.md`
  - `source/input_reconstruction_notes.md`
- internal:
  - `README.md`
  - `glossary.md`
  - `priorities.md`
...
- IA 자체는 현재 일관된다.
  - `docs/ko/index.md`가 포털 역할을 하고,
  - `docs/ko/design/index.md`는 옛 경로가 비어 보이는 혼란을 막는 호환 안내 역할을 한다.
- canonical/current/history 경계도 대체로 유지된다.
  - explanation은 프로젝트 철학과 범위를,
  - reference는 계약과 정의를,
  - how-to는 도구 사용 절차를,
  - reading은 proposal/history/example note를 담는다.
- `current_formula_reference.md`는 이전보다 풍부해졌지만,
...
- explanation 문서는 메타 블록을 걷어냈지만,
  `base_field_foundation.md`처럼 문단 밀도가 높은 문서는 사람 가독성이 아직 약하다.
- `docs/ko/index.md`는 포털 역할을 잘 수행하지만,
...
- `project_overview.md`는 비교적 읽히는 설명 문서에 가깝다.
- `base_field_foundation.md`는 핵심 개념을 담고 있지만 문단당 주장 수가 많고,
  영문 용어가 잦아 사람이 읽을 때 조밀하게 느껴진다.
- `research_scope.md`는 범위를 잘 고정하지만, 현재 explanation 톤보다 status 톤에 더 가깝게 읽힌다.
...
- `phase5_adapter_proposal.md`는 history 문서로 충분하다.
- `input_reconstruction_notes.md`는 source/input 주변 notes를 한곳에 잘 모았지만,
...
- `docs/ko/index.md` 중심의 포털 구조
- `docs/ko/design/index.md`를 통한 호환 안내
