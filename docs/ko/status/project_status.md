...
- Gaussian anchor blended progress coordinates + guide-center distance transverse + hard max envelope 현재 구현 정리
...
- 현재 구현은 Gaussian anchor blended progress coordinates, guide-center distance transverse, hard max envelope를 사용한다.
