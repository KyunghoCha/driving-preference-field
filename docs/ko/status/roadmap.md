...
현재 프로젝트는 **Phase 5 완료, Phase 6 준비 상태**다.
...
- current decision SSOT: `docs/ko/reference/source_adapter.md`
- proposal history: `docs/ko/reading/history/phase5_adapter_proposal.md`
...
- 자세한 설계 근거는 `docs/ko/explanation/`, `docs/ko/reference/`, `docs/ko/how-to/`에 둔다.
- 구체 source 사례는 `docs/ko/reading/`에 둔다.
- 내부 우선순위는 `docs/ko/internal/priorities.md`에서 관리한다.
