...
현재 canonical 정의는 `docs/design/` 아래 문서를 기준으로 읽는다.
...
- `./ssc_input_mapping_ko.md`
- `./input_capability_tiers_ko.md`
- `./archive_score_field_notes_ko.md`

## 사용 원칙

- 이 목록은 참고 자료 경로만 제공한다.
- archive 문서는 canonical 정의를 대신하지 않는다.
- 새 설계 정의는 `docs/design/` 문서에서만 고정한다.
