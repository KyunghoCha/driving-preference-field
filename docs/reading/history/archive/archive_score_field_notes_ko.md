...
이 문서는 archive 문서에서 현재도 참고 가치가 있는 아이디어를 reading note 수준으로만 정리한다.
...
주행 표현은 discrete path나 trajectory보다 앞단에서 정의될 수 있다. 즉 optimizer나 planner가 소비할 base structure를 먼저 세울 수 있다는 관점은 계속 유효하다.
...
## 현재 기준에서 reading으로만 남기는 이유

archive 문서는 형성 과정과 실험 흔적을 담고 있기 때문에, 현재 canonical 문서와 같은 층에서 읽으면 정의가 흔들릴 수 있다.

따라서 archive 문서는 아이디어 참고와 reading note로만 유지한다.

## 현재 기준 결론

archive 문서는 canonical truth가 아니라, 문제의식과 참고 아이디어를 되짚는 보조 자료로만 사용한다.
